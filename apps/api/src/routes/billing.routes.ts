...
router.get('/stats', hybridAuthMiddleware, requirePermissionIfApiKey('usage'), billingController.getUsageStats);
router.get('/plans', billingController.getPlans);
router.post('/upgrade', hybridAuthMiddleware, billingController.upgradePlan);
router.get('/invoices', hybridAuthMiddleware, requirePermissionIfApiKey('usage'), billingController.getInvoices);
