 ...
 *
 * Uses a dedicated Base Mainnet publicClient (separate from the Sepolia client
 * in blockchain.service.ts) because Coinbase attestations live on Base Mainnet.
 */
...
// Dedicated Base Mainnet client for EAS queries
