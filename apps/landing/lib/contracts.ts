...
export const ADDRESSES = {
    ...
    COMPLIANCE_HOOK: '0x54b88a4aAC9E73F6581C19a06a2DC280Eba78a80' as `0x${string}`,
    ...
    tUSDC: (process.env.NEXT_PUBLIC_USDC_ADDRESS || '0xa486Fb51ED09B970A23F7Fe910bc90089f78424D') as `0x${string}`,
