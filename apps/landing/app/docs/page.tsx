...
export default function DocsPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-12">
        <h1 className="font-heading text-4xl font-bold mb-4">ILAL API Documentation</h1>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        <Link
          ...
          className="border border-white/10 rounded-xl p-6 hover:border-[#00F0FF]/50 hover:bg-white/[0.02] transition-all group"
        >
          <Zap className="w-8 h-8 text-[#00F0FF] mb-4" />
          <h3 className="font-heading text-lg font-semibold mb-2">Quick Start</h3>
          <p className="text-sm text-gray-400 mb-4">
            Make your first API call in 5 minutes
          </p>
          <div className="flex items-center text-[#00F0FF] text-sm group-hover:underline">
        ...
        <Link
          ...
          className="border border-white/10 rounded-xl p-6 hover:border-[#00F0FF]/50 hover:bg-white/[0.02] transition-all group"
        >
          <Lock className="w-8 h-8 text-[#00F0FF] mb-4" />
          <h3 className="font-heading text-lg font-semibold mb-2">Authentication</h3>
          <p className="text-sm text-gray-400 mb-4">
        ...
        >
          ...
          <h3 className="font-heading text-lg font-semibold mb-2">API Endpoints</h3>
          <p className="text-sm text-gray-400 mb-4">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-xl p-6 mb-8">
          <h3 className="font-heading text-xl font-semibold mb-4">Core Features</h3>
        ...
        <h2 className="font-heading text-2xl font-bold mb-4">API Basics</h2>
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-xl p-6 mb-6">
          <div className="mb-4">
            ...
            <code className="text-[#00F0FF] bg-white/5 px-3 py-1.5 rounded">
        ...
        <h2 className="font-heading text-2xl font-bold mb-4">Rate Limits</h2>
        ...
        <h2 className="font-heading text-2xl font-bold mb-4">Getting Started</h2>
        <p className="text-gray-400 mb-6">
          Head to the <Link href="/docs/quickstart" className="text-[#00F0FF] hover:underline">Quick Start</Link> page
