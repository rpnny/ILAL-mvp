...
const INIT_CODE_HASH = '0x03ba222c48177543ae31e1f8ac5ff911eb4faf95f71308a2c9037b21e0310750' as Hex;
...
async function main() {
  ...
  for (let i = 0; i < Number.MAX_SAFE_INTEGER; i++) {
    ...
    if (checkAddress(address)) {
      ...
      await import('fs').then(fs => fs.default.writeFileSync('.hook-address', output));
